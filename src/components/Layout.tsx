    ...
    <div className="flex flex-col min-h-screen bg-black">
      <header 
        className={cn(
          ...
          isScrolled 
            ? 'bg-black/80 backdrop-blur-md py-3 shadow-lg shadow-blue-400/10' 
            : 'bg-transparent py-5'
        )}
      >
        <div className="container mx-auto px-4 flex justify-between items-center">
          <Link href="/" className="flex items-center">
            <span className="text-2xl font-bold bg-linear-to-r from-blue-400 via-teal-500 to-green-500 bg-clip-text text-transparent">
              DevPortfolio
            </span>
          </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <span className="text-lg font-bold bg-linear-to-r from-blue-400 via-teal-500 to-green-500 bg-clip-text text-transparent">
                DevPortfolio
              </span>
            ...
            <div className="flex items-center space-x-4">
              <a 
                href="https://github.com/LocoIcee" 
                target="_blank" 
              ...
              <a 
                href="https://linkedin.com/in/cameron-hill-26619b183" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-green-500 transition-colors"
              >
